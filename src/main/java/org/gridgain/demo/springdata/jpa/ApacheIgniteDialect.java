...
/**
 * A dialect compatible with the Apache Ignite database.
 */
public class ApacheIgniteDialect extends Dialect {
	private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class,
			ApacheIgniteDialect.class.getName());
	...
	/**
	 * Constructs a ApacheIgniteDialect
	 */
	public ApacheIgniteDialect() {
		super();

		boolean supportsTuplesInSubqueries = true;
	...
	public MultiTableBulkIdStrategy getDefaultMultiTableBulkIdStrategy() {
		return new LocalTemporaryTableBulkIdStrategy(new IdTableSupportStandardImpl() {
			...
			public String getCreateIdTableStatementOptions() {
				...
				// 2) [transactional] - says to not perform an implicit commit of any current
				// transaction
